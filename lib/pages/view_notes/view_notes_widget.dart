...
class ViewNotesWidget extends StatefulWidget {
  const ViewNotesWidget({
    super.key,
    required this.notesdonref,
  });

  final DocumentReference? notesdonref;
...
class _ViewNotesWidgetState extends State<ViewNotesWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<NotesRecord>(
      stream: NotesRecord.getDocument(widget.notesdonref!),
      builder: (context, snapshot) {
        ...
        final viewNotesNotesRecord = snapshot.data!;
